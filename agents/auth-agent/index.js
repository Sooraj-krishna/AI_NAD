...
Ensure the frontend provider handles login, logout, and persistent auth state.`;
            ...
            logger_1.Logger.error('Firebase Auth Agent error', error);
            return {
                success: false,
    ...
    parseFileArray(text) {
        try {
            ...
            logger_1.Logger.warn('⚠️ Could not parse Firebase Auth file array');
            return [];
        }
    }
}
exports.FirebaseAuthAgent = FirebaseAuthAgent;
